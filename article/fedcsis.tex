...
\IEEEauthorblockA{0000-0002-7501-7048\\
...
\IEEEauthorblockA{0000-0000-0000-7048\\0000-0002-0000-0000\\
...
The conference cite contains also the latest version of this document and its source.
\section{Preamble}

\subsection{Document Class}
Please, initialize the document class in the standard way and use the command \mintinline{latex}{\IEEEoverridecommandlockouts} to unlock some macros:
\begin{minted}{latex}
\documentclass[conference]{IEEEtran}
\IEEEoverridecommandlockouts
\end{minted}
...
produced using the IEEEtran command \mintinline{latex}|\IEEEPARstart{}{}|. The first argument is the first letter of the first word, the
...
upper case if the first word is very short (less than 3~letters). The drop cap of this document was produced with
\begin{minted}{latex}
\IEEEPARstart{T}{o prepare}
\end{minted}

\subsection{ORCID}
Place ORCIDs of all the authors in the line next to author's name, in the \mintinline{latex}|\IEEEauthorblockA{}| block.

\subsection{Last Page Columns Balancing}
 To balance the column lengths on the last page of the document use the package \verb|pbalance|. It is sufficient to include the package in the preamble:
\begin{minted}{latex}
\usepackage{pbalance}
\end{minted}
